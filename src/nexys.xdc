...
#set_property -dict { PACKAGE_PIN H4    IOSTANDARD LVCMOS33 } [get_ports {div_clk_debug}]; #IO_L21N_T3_DQS_35 Sch=jd[1]
#set_property -dict { PACKAGE_PIN H1    IOSTANDARD LVCMOS33 } [get_ports {query_debug}]; #IO_L17P_T2_35 Sch=jd[2]
#set_property -dict { PACKAGE_PIN G1    IOSTANDARD LVCMOS33 } [get_ports {tx_debug}]; #IO_L17N_T2_35 Sch=jd[3]
#set_property -dict { PACKAGE_PIN G3    IOSTANDARD LVCMOS33 } [get_ports {rx_debug}]; #IO_L20N_T3_35 Sch=jd[4]
